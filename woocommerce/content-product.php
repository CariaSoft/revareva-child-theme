...
?>
<div <?php wc_product_class( 'product-card position-relative', $product ); ?>>
	<?php
	/**
	...
	<div class="product-image position-relative">
		...
		?>
		<div class="product-hover-overlay d-flex flex-column">
			...
			<a href="#" class="heart-icon" onclick="event.stopPropagation();">
