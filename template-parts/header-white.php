...
<!-- White Header – Birebir kategori.html eşleşmesi: beyaz bg, siyah logo/icon/link, statik -->
<header id="mainHeader" class="navbar navbar-expand-lg fixed-top navbar-dark bg-white">
    <div class="container-fluid px-1 px-sm-2 px-md-3 px-lg-4 px-xl-4 mt-2">
        <!-- Logo: Siyah, height 40, tema ayarından -->
        <a class="navbar-brand" href="<?php echo esc_url( home_url( '/' ) ); ?>">
            <?php
            $dark_logo_id = get_theme_mod( 'dark_logo' ); // Açık Arka Plan Logosu (Siyah)
            ...
            ?>
            <img src="<?php echo esc_url( $dark_url ); ?>" alt="<?php bloginfo( 'name' ); ?>" height="40" class="logo-dark" />
        </a>

        <!-- Menü: Koyu siyah, uppercase, fw-medium, statik -->
