...
<header id="mainHeader" class="navbar navbar-expand-lg fixed-top navbar-dark bg-transparent">
    <div class="container-fluid px-1 px-sm-2 px-md-3 px-lg-4 px-xl-5 mt-2">
        ...
        <a class="navbar-brand" href="<?php echo home_url(); ?>">
            ...
            $light_url = $light_logo_id
                ? wp_get_attachment_image_src($light_logo_id, 'full')[0]
                : get_template_directory_uri() . '/assets/img/caria-logo.png';
            ...
            ?>
            <img src="<?php echo esc_url($light_url); ?>" class="logo-white" height="40" alt="Logo">
            <img src="<?php echo esc_url($dark_url); ?>" class="logo-dark d-none" height="40" alt="Logo">
        </a>
